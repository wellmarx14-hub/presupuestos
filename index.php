...
<head>
	...
	<meta name="author" content="Wellmar C" />
	<!--[if IE]>
...
<body>
				...
				<div class="row ">
					...
					<div class="col-lg-6 col-md-6 col-sm-6">
						...
						<textarea class="form-control" id="descripcion" name="descripcion" required
							placeholder="Ingresa la descripción del proyecto"></textarea>
	...
	<form class="form-horizontal" name="guardar_cliente" id="guardar_cliente">
		<!-- action="ajax/clientes.php"-->
		<!-- Modal Clientes -->
		<div class="modal fade bs-example-modal-lg" id="myModalx" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-md-12">
								<label>Nombre y razon social</label>
